...
extern {
    ...
    pub fn vorbis_comment_query_count(vc: *mut vorbis_comment,
    ...
    pub fn vorbis_granule_time(v: *mut vorbis_dsp_state,
		granulepos: ogg::ogg_int64_t) -> libc::c_double;
    ...
    pub fn vorbis_commentheader_out(vc: *mut vorbis_comment,
    ...
    pub fn vorbis_analysis_buffer(v: *mut vorbis_dsp_state,
		vals: libc::c_int) -> *mut *mut libc::c_float;
    pub fn vorbis_analysis_wrote(v: *mut vorbis_dsp_state, vals: libc::c_int) -> libc::c_int;
    pub fn vorbis_analysis_blockout(v: *mut vorbis_dsp_state,
		vb: *mut vorbis_block) -> libc::c_int;
    ...
    pub fn vorbis_bitrate_flushpacket(v: *mut vorbis_dsp_state,
		op: *mut ogg::ogg_packet) -> libc::c_int;
    ...
    pub fn vorbis_synthesis_pcmout(v: *mut vorbis_dsp_state,
		pcm: *mut *mut *mut libc::c_float) -> libc::c_int;
    pub fn vorbis_synthesis_lapout(v: *mut vorbis_dsp_state,
		pcm: *mut *mut *mut libc::c_float) -> libc::c_int;
	...
	pub fn vorbis_encode_init(vi: *mut vorbis_info, channels: libc::c_long, rate: libc::c_long,
		max_bitrate: libc::c_long, nominal_bitrate: libc::c_long,
		min_bitrate: libc::c_long) -> libc::c_int;
	pub fn vorbis_encode_init_vbr(vi: *mut vorbis_info, channels: libc::c_long, rate: libc::c_long,
		base_quality: libc::c_float) -> libc::c_int;
}
